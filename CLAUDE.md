...
# Q_rad-driven tree optimizer: minimize the rms residual directly (greedy grow by default)
uv run python qrad_optimize.py --model G2_1D.dat --max-seconds 600 --save-plot opt.png
# ...non-greedy beam search over guillotine-tree topologies (writes the optimized kappa table):
