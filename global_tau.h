...
#define LN10 4.342944819032518e-1
...
// for full ODF
#define cont_scatter 0
// Include continuum Scattering
//#define Nbands 1
/* double Level_tau_bot[Nbands] = { -99};
double Level_tau_top[Nbands] = {99};
double Level_nu_bot[Nbands] = {0};
double Level_nu_top[Nbands] = {999};
double TAU1_2[Nbands] = {0.35};
*/

#define Nbands 2
double Level_tau_bot[Nbands] = {-4.5e0,-99.0};
double Level_tau_top[Nbands] = {99.0e0,-4.5e0};
...
// Temperature Axis - New ODFs constant logT
#define NT 300
#define Tmin  1.5e3
#define Tmax  1.5e5

double delta_logT,inv_delta_logT;
double tab_T[NT];

// Pressure Axis - New ODFs constnat logp
#define Np 150
#define pmin 1.0e-4
#define pmax 1.0e8

double delta_logp,inv_delta_logp;
double tab_p[Np];
